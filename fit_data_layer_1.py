...
data = np.load(c.intermediate_path + 'dataset_data_0_layer_1.npy')
...
with timer.Timer() as t:
	...
	data_io.save_random_forest(random_forest_classifier, c.intermediate_path, 'random_forest_' + str(k) + '_layer_1.pkl.tar.gz')
